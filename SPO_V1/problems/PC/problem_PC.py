...
class PCDataset(Dataset):
    def __init__(self, filename=None, size=50, num_samples=5000, offset=0, p=8, r=1, distribution=None):
        ...
        if filename is not None:
            ...
            self.data = [dict(loc=torch.FloatTensor(size, 2).uniform_(0, 1), p=p, r=r) for i in range(num_samples)
                         ]

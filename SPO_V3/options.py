...
def get_options(args=None):
    ...
    # Data
    parser.add_argument('--problem', default='PM', choices=['PM', 'PC', 'MCLP', 'LSCP'],
                        help="The problem to solve, default 'PM'")
    parser.add_argument('--graph_size', type=int, default=20, help="The number of the points")
    parser.add_argument('--p', type=int, default=4, help="The number of the medians")
    parser.add_argument('--r', type=float, default=0.3, help="The maximum service distance (coverage radius)")
    ...
    opts.save_dir = os.path.join(
        opts.output_dir,
        "{}_{}_{}".format(opts.problem, opts.graph_size, opts.p),
        opts.run_name
    )

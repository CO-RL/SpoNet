# Attention Model for solving P-median, P-center and MCLP.

Attention based model for learning to solve the P-median, P-center and MCLP. Training with REINFORCE with greedy rollout baseline.
...
For training P-median instances with 20 nodes 4 medians and using rollout as REINFORCE baseline:
```bash
python run.py --graph_size 20 --p 4 --run_name 'PM20'
```

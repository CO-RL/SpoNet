...
class StatePC(NamedTuple):
    ...
    def get_length(self, facility):
        ...
        lengths = torch.max(torch.min(f_u_dist_tensor, dim=1)[0], dim=-1)
        return lengths
    ...
    def update(self, selected):
        ...
        return self._replace(first_a=first_a, visited_=visited_, facility=new_facility,
                             prev_a=prev_a, length=new_length, i=self.i+1)

...
class AttentionModel(nn.Module):
    ...
    def _get_log_p(self, fixed, state, normalize=True):
        ...
        if self.is_dy:
            dynamic_hidden1 = self.init_dynamic(state.get_dynamic().transpose(1, 2))
            dynamic_hidden2 = self.l2_dynamic(dynamic_hidden1)
            dynamic_hidden = self.l3_dynamic(dynamic_hidden2)
